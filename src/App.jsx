    ...
    <section className="repo-stage">
      <div className="repo-stage-header">
        <div className={`stepper ${selected ? 'step-3' : token ? 'step-2' : 'step-1'}`}>
          <div className="step-item active">1. Connect to Git provider</div>
          <div className={`step-item ${token ? 'active' : ''}`}>2. Select repository</div>
          <div className={`step-item ${selected ? 'active' : ''}`}>3. Configure wall</div>
        </div>
